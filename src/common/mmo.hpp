...
#define MAX_GUILD_STORAGE 200 ///Max number of storage slots a guild
#define MAX_PARTY 12 ///Max party member
// #define MAX_GUILD 16+10*6	///Increased max guild members +6 per 1 extension levels [Lupus]
#define MAX_GUILD 16+10*2	///Increased max guild members +2 per 1 extension levels [Lupus] (Max 36)
